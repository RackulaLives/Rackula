...
const fuseOptions: IFuseOptions<DeviceType> = {
  keys: [
    ...
    { name: "notes", weight: 1 },
    { name: "custom_fields.rackula_fit.status", weight: 1 },
    { name: "custom_fields.rackula_fit.mount_type", weight: 1 },
    { name: "custom_fields.rackula_fit.power_method", weight: 1 },
    { name: "custom_fields.rackula_fit.open_checks", weight: 1 },
  ],
  threshold: 0.3,
  ignoreLocation: true,
  includeScore: true,

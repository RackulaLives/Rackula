...
export const deskpiDevices: DeviceType[] = [
  ...
  {
    slug: "deskpi-rackmate-1u-utility-tray",
    u_height: 1,
    manufacturer: "DeskPi",
    model: "RackMate 1U Utility Tray Placeholder",
    is_full_depth: false,
    is_powered: false,
    slot_width: 1,
    rack_widths: [10],
    ...
    category: "shelf",
    notes:
      "Planning placeholder for a shallow 10-inch shelf or printable tray for desktop network gear.",
    custom_fields: {
      rackula_fit: {
        status: "needs_mount_selection",
        mount_type: "shelf-or-3d-printed-tray",
      },
    },
    slots: [
      {
        ...
        width_fraction: 1,
        height_units: 1,
        accepts: ["network", "firewall", "power", "other"],
      },
    ],
  },
  {

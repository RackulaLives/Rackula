...
describe('Delete device type', () => {
	...
	it('shows delete button for custom devices', () => {
		...
		expect(screen.getByRole('button', { name: /delete from library/i })).toBeInTheDocument();
	});
	...
	it('does not show delete button for starter library devices', () => {
		...
		expect(screen.queryByRole('button', { name: /delete from library/i })).not.toBeInTheDocument();

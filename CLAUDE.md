...
- **File size limit:** 400 lines per test file (CI will fail above this)
- **Ratio limit:** Test:source ratio ≤ 0.6:1 (CI will fail above this)
- **Zero-change rule:** Adding data should require zero test changes

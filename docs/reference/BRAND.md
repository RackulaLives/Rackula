...
**Version:** 0.6.0 **Last Updated:** 2025-12-15 **Source:** Derived from `01-PROJECTS/Rackula/brand-guide.md` with accessibility improvements
...
:root {
  --focus-ring:
    0 0 0 2px var(--colour-bg), 0 0 0 4px var(--colour-pink),
    var(--glow-pink-sm);
}
```

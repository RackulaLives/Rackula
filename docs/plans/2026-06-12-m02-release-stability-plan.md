...
Key files: deploy/Dockerfile, .github/workflows/build-lxc.yml, .github/workflows/deploy-prod.yml, e2e/playwright.smoke.config.ts, src/app.html (or wherever the conditional script tag lands), deploy/security-headers.conf, deploy/lxc/security-headers.conf
